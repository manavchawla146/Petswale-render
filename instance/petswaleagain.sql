...
--
-- Host: localhost    Database: petpocket
-- ------------------------------------------------------
...
CREATE TABLE `addresses` (
  ...
  `street_address` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL,
  `apartment` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `cart_items` VALUES (1,1,1,1),(2,1,1,2);
...
CREATE TABLE `users` (
  ...
  `password_hash` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `wishlist_items` VALUES (1,1,24),(4,1,30),(5,1,19),(6,1,18);
...
-- Dump completed on 2025-07-18  0:04:45
