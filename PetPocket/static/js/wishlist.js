document.addEventListener('DOMContentLoaded', function () {
    ...
    // ✅ FIXED: Function to create a product card HTML string with discount price and proper rating
    function createProductCard(product) {
        const avgRating = product.avg_rating ? Math.floor(product.avg_rating) : 0;  // ✅ Use Math.floor instead of Math.round
        let starsHtml = '';
        for (let i = 0; i < 5; i++) {
            const starClass = i < avgRating ? 'filled' : 'empty';
        ...
        return `
            <div class="product-card" data-product-id="${product.id}">
              ...
              <div class="product-card-bottom">
                ...
                <!-- ✅ Updated price and rating structure -->
    ...
    // Function to attach event listeners to wishlist items
