...
def create_app(config_class=Config):
    ...
    app.config['RAZORPAY_KEY_ID'] = os.environ.get('RAZORPAY_KEY_ID', 'rzp_live_RGkEP4XjZZVrxv')
    app.config['RAZORPAY_KEY_SECRET'] = os.environ.get('RAZORPAY_KEY_SECRET', 'LR0Iqe9U0XVEPzsxYo78MmOe')
    
    # Replace with valid credentials from Google Cloud Console
    app.config['GOOGLE_CLIENT_ID'] = os.environ.get('GOOGLE_CLIENT_ID', '1047039162052-7e0fgrt2prvkcl2ta0ojao471ifs0c01.apps.googleusercontent.com')
    app.config['GOOGLE_CLIENT_SECRET'] = os.environ.get('GOOGLE_CLIENT_SECRET', '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')
    ...
    app.config.update(
        ...
        MAIL_DEFAULT_SENDER=('PetPocket Admin', os.environ.get('MAIL_USERNAME', 'manavdodani2005@gmail.com'))
    )
