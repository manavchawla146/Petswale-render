...
class EmailView(SecureBaseView):
    ...
    def send_email(self):
        ...
        current_app.config.update(
            ...
            MAIL_PORT=587,
            MAIL_USE_TLS=True,
            MAIL_USERNAME='petswale.in@gmail.com',
            MAIL_PASSWORD='glhrkvzwfxkusqia',
            MAIL_DEFAULT_SENDER='petswale.in@gmail.com'
        )
...
class ProductView(SecureModelView):
    column_list = ['name', 'price', 'discount_price', 'stock', 'category.name', 'pet_type.name', 'weight', 'parent.name']
    column_searchable_list = ['name', 'description']
    column_filters = ['price', 'discount_price', 'stock', 'category.name', 'pet_type.name', 'weight']
    form_columns = ['name', 'description', 'price', 'discount_price', 'stock', 'image_url', 'category', 'pet_type', 'weight', 'parent']
    column_formatters = {
        'price': formatter_price,
        'discount_price': formatter_price
    }
